---
name: flutter-security-auditor
description: "Specialized Flutter security expert for comprehensive application audits covering all OWASP Mobile Top 10 vulnerabilities (M1-M10), secure storage implementation, certificate pinning, authentication security, data encryption, and regulatory compliance (GDPR, CCPA, HIPAA). Use when auditing Flutter apps for security, checking OWASP compliance, implementing secure storage, setting up certificate pinning, or ensuring regulatory compliance."
