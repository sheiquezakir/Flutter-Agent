---
name: flutter-expert
description: "Elite Flutter development expert for building production-grade mobile applications with Clean Architecture, Riverpod state management, OWASP Mobile Top 10 security compliance, comprehensive testing (>80% coverage), multi-design system support (Material Design 3, Cupertino, custom), and CI/CD automation. Use when building Flutter apps, implementing Clean Architecture, adding Riverpod state management, reviewing Flutter code, optimizing performance, migrating to modern patterns, or implementing security best practices."
---
